    ...
    return (
      <BrowserRouter>
        <Switch>
          ...
          <Route exact path="/Iniciarsesión" component={Iniciarsesion} />
          ...
          <Route exact path="/FormatoDisciplinario" component={FormatoDisciplinario}/>
          <Route exact path="/SeguimientoAcudiente" component={SeguimientoAcudiente}/>
          <Route exact path="/SeguimientoDocente" component={SeguimientoDocente}/>
          <Route exact path="/SeguimientoEstudiante" component={SeguimientoEstudiante}/>
